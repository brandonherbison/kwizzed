...
export const Profile = () => {
    ...
    return <>
        ...
        <div className="grid grid-cols-1 justify-items-center gap-2 w-4/5 lg:w-1/5 m-auto -mt-40 p-6 bg-white border border-ronBurgundy border-2 rounded-lg shadow-xl bg-walterWhite">
